        ...
        <div class="flex flex-1">
            ...
            <aside class="w-64 bg-white shadow-md p-5">
                <ul>
                    ...
                    <li class="mb-4"><a href="./appliances/usage_analytics.php" class="text-blue-600">📊 Usage Analytics</a></li>
                    <li class="mb-4"><a href="./appliances/notification2.php" class="text-blue-600">🔔 Notifications</a></li>
                    <li class="mb-4"><a href="./appliances/setting.php" class="text-blue-600">⚙️ Settings</a></li>
                </ul>
            </aside>
